...
export default defineConfig(({ mode }) => ({
  ...
  build: {
    ...
    // Let Rollup preserve the dependency graph when splitting bundles.
    // Forced vendor groups can create cross-chunk initialization cycles in
    // production browsers (notably Samsung Internet and Safari/WebKit).
  },
}));
