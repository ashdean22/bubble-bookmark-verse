        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          ...
          <div>
            ...
            <ul className="space-y-2 text-sm">
              ...
              <li>
                <a href="mailto:legal@bubblelink.app" className="text-purple-300 hover:text-white transition-colors">
                  Cookie Policy
                </a>
              </li>
            </ul>
          ...
          <div>
            ...
            <div className="flex space-x-4 mb-4">
              ...
              <a href="mailto:hello@bubblelink.app" className="text-purple-300 hover:text-white transition-colors">
                <Mail className="w-5 h-5" />
              </a>
            </div>
            <ul className="space-y-2 text-sm">
              <li>
                <a href="mailto:support@bubblelink.app" className="text-purple-300 hover:text-white transition-colors">
                  Support
                </a>
              </li>
              <li>
