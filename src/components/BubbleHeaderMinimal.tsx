      ...
      <div className="max-w-7xl mx-auto">
        <div className="flex items-center justify-between">
          ...
          <div className="flex items-center relative">
            <div className="h-44 md:h-56 w-44 md:w-56 rounded-full overflow-hidden drop-shadow-lg animate-logo-glow flex items-center justify-center shrink-0" style={{ background: '#0ec0d9' }}>
              <img 
                src={bubbleLinkLogo} 
